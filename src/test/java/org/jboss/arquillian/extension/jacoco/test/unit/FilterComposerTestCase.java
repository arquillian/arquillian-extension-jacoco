...
public class FilterComposerTestCase
{
   ...
   {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.client.*", null);
   ...
   {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.client.*", "org.jboss.arquillian.extension.jacoco.*");
   ...
   {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.client.*", "org.jboss.arquillian.extension.integration.*");
   ...
   {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.client.*", "*");
   ...
   public void should_include_all_assets_from_include_except_those_defined_in_exclude() throws Exception {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.client.*", "org.jboss.arquillian.extension.jacoco.container.*,org.jboss.arquillian.extension.jacoco.client.filter.*" );
   ...
   public void should_exclude_asset_in_case_of_any_conflict() throws Exception {
      // given
      final Filter<ArchivePath> filter = FilterTestUtils.createComposedFilter("org.jboss.arquillian.extension.jacoco.*, org.jboss.arquillian.extension.jacoco.client.*, org.jboss.arquillian.extension.jacoco.container.CoverageDataCommand",
              "org.jboss.arquillian.extension.jacoco.container.*,org.jboss.arquillian.extension.jacoco.client.filter.*" );
